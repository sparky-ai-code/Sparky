...
import { EnvironmentProject, EnvironmentThreadShell } from "@sparky/client-runtime/state/shell";
import type { AtomCommandResult } from "@sparky/client-runtime/state/runtime";
import {
  type GitActionRequestInput,
  type VcsActionOperation,
  type VcsRef,
} from "@sparky/client-runtime/state/vcs";
import type { GitRunStackedActionResult } from "@sparky/contracts";
import {
