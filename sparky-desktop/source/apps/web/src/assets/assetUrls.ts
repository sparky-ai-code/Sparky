...
import { resolveAssetUrl } from "@sparky/client-runtime/state/assets";
import type { AssetResource, EnvironmentId } from "@sparky/contracts";
...
export { resolveAssetUrl } from "@sparky/client-runtime/state/assets";
