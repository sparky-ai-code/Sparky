...
export const DesktopConfig = Config.all({
  ...
  desktopAppRoot: trimmedString("T3CODE_DESKTOP_APP_ROOT"),
  desktopBackendEntry: trimmedString("T3CODE_DESKTOP_BACKEND_ENTRY"),
  desktopBackendCwd: trimmedString("T3CODE_DESKTOP_BACKEND_CWD"),
