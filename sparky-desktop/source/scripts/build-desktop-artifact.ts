...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
  ...
  const buildConfig: Record<string, unknown> = {
    ...
    extraResources: [
      { from: "apps/desktop/resources/sparky", to: "sparky" },
      ...(platform === "win"
...
const buildDesktopArtifact = Effect.fn("buildDesktopArtifact")(function* (
  ...
  if (!options.skipBuild) {
    ...
    const rustRoot = path.resolve(repoRoot, "../..");
    yield* Effect.log("[desktop-artifact] Building the Sparky Rust runtime...");
    const cargoCommand = yield* resolveSpawnCommand("cargo", [
      "build",
      "--release",
      "--package",
      "sparky_cli",
    ...
    yield* runCommand(
      ChildProcess.make(cargoCommand.command, cargoCommand.args, {
        cwd: rustRoot,
        shell: cargoCommand.shell,
      }),
      { label: "cargo build --release --package sparky_cli", verbose: options.verbose },
    );
  }
