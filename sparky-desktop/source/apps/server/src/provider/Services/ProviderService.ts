...
export interface ProviderServiceShape {
  ...
  /**
   * Acquire an eager subscription to the canonical runtime event fan-out.
   *
   * Consumers that start immediately after ProviderService construction use
   * this to avoid losing the first event while a lazy Stream.fromPubSub
   * subscription is still being established. The optional shape preserves
   * compatibility with small test/fallback services.
   */
