  ...
  if (collapsible === "none") {
    return (
      <SidebarInstanceContext value={instanceContextValue}>
        <div
          className={cn(
            "flex h-full w-(--sidebar-width) flex-col bg-sidebar dark:bg-[#070707] surface-grain text-sidebar-foreground",
            className,
          )}
          data-slot="sidebar"
          {...props}
    ...
    return (
      <SidebarInstanceContext value={instanceContextValue}>
        <Sheet onOpenChange={setOpenMobile} open={openMobile} {...props}>
          <SheetPopup
            className={cn(
              "w-(--sidebar-width) max-w-none bg-sidebar dark:bg-[#070707] surface-grain p-0 text-sidebar-foreground",
              className,
            )}
            data-mobile="true"
  ...
  return (
    <SidebarInstanceContext value={instanceContextValue}>
      ...
      >
        ...
        >
          <div
            className="flex h-full w-full flex-col bg-sidebar dark:bg-[#070707] surface-grain group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm/5"
            data-sidebar="sidebar"
