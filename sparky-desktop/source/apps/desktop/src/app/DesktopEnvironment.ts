...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  return DesktopEnvironment.of({
    ...
    resolveResourcePathCandidates: (fileName) => [
      // Windows loads ICOs through native APIs, which cannot read inside app.asar.
      // Prefer the real file staged by electron-builder's extraResources.
      ...(input.isPackaged && input.platform === "win32" && fileName === "icon.ico"
