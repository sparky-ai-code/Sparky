import type { PreviewAnnotationPayload } from "@sparky/contracts";
        ...
        return (
          ...
          >
            {image?.previewUrl ? (
              ...
              <span className="grid size-10 shrink-0 place-items-center border-r border-border/70 text-foreground">
