  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="General">
        ...
        <SettingsRow
          title="Focus Mode"
          description="Dim working and inactive threads so completed work stays easy to scan."
          resetAction={
            settings.focusMode !== DEFAULT_UNIFIED_SETTINGS.focusMode ? (
              <SettingResetButton
                label="focus mode"
                onClick={() => updateSettings({ focusMode: DEFAULT_UNIFIED_SETTINGS.focusMode })}
              />
            ) : null
          }
          control={
            <Switch
              ...
              onCheckedChange={(checked) => updateSettings({ focusMode: Boolean(checked) })}
