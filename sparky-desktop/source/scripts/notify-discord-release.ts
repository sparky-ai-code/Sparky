  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Sparky prerelease is available for nightly testers."
          : "A new Sparky latest release is available.",
...
).pipe(Command.withDescription("Post a Sparky release announcement to Discord."));
