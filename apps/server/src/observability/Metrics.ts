...
export const providerFirstRuntimeEventDuration = Metric.timer(
  "t3_provider_first_runtime_event_duration",
  {
    description: "Time from provider turn dispatch to the first canonical provider runtime event.",
  },
);

export const providerFirstAssistantDeltaDuration = Metric.timer(
  "t3_provider_first_assistant_delta_duration",
  {
    description: "Time from provider turn dispatch to the first assistant text delta.",
  },
);

export const providerRuntimeEventProcessingDuration = Metric.timer(
  "t3_provider_runtime_event_processing_duration",
  {
    description: "Time spent canonicalizing, persisting, and publishing one provider runtime event.",
  },
);
