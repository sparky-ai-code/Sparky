...
import { HostProcessEnvironment } from "@sparky/shared/hostProcess";
...
const MODE_ARGS = {
  ...
  "dev:web": ["run", "--filter=@sparky/web", "dev"],
  "dev:desktop": ["run", "--filter=@sparky/desktop", "--filter=@sparky/web", "dev"],
