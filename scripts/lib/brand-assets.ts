export const BRAND_ASSET_PATHS = {
  ...
  productionIosIconPng: "assets/prod/sparky-ios-1024.png",
  productionMacIconPng: "assets/prod/sparky-macos-1024.png",
  productionLinuxIconPng: "assets/prod/sparky-universal-1024.png",
  productionWindowsIconIco: "assets/prod/sparky-windows.ico",
  productionWebFaviconIco: "assets/prod/sparky-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/sparky-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/sparky-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/sparky-web-apple-touch-180.png",
