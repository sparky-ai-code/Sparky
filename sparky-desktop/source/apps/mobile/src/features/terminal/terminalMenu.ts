import { type KnownTerminalSession } from "@sparky/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@sparky/contracts";
...
} from "@sparky/shared/terminalLabels";
