...
export const PICK_FILE_OR_FOLDER_CHANNEL = "desktop:pick-file-or-folder";
export const CONFIRM_CHANNEL = "desktop:confirm";
export const SET_THEME_CHANNEL = "desktop:set-theme";
export const CONTEXT_MENU_CHANNEL = "desktop:context-menu";
export const OPEN_EXTERNAL_CHANNEL = "desktop:open-external";
export const CLERK_CALLBACK_CHANNEL = "desktop:clerk-callback";
...
export const GITHUB_CLI_STATUS_CHANNEL = "desktop:github-cli-status";
export const GITHUB_CLI_INSTALL_CHANNEL = "desktop:github-cli-install";
export const GITHUB_CLI_AUTH_CHANNEL = "desktop:github-cli-auth";
export const GITHUB_AUTH_DISCONNECT_CHANNEL = "desktop:github-auth-disconnect";
export const GITHUB_PLUGIN_SYNC_CHANNEL = "desktop:github-plugin-sync";
