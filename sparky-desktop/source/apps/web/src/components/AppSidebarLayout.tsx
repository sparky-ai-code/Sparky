...
import { PluginsSidebarEntry } from "./plugins/PluginsSidebarEntry";
import { PullRequestsSidebarEntry } from "./pullRequests/PullRequestsSidebarEntry";
import {
