...
import * as GitHubCliIpc from "./methods/githubCli.ts";
import { getPullRequestDiffMethod } from "./methods/githubPullRequestDiff.ts";
import { syncGitHubPluginConnectionMethod } from "./methods/githubPluginSync.ts";
import {
...
export const installDesktopIpcHandlers = Effect.fn("desktop.ipc.installHandlers")(function* () {
  ...
  yield* ipc.handle(GitHubCliIpc.getStatus);
  yield* ipc.handle(GitHubCliIpc.install);
  yield* ipc.handle(GitHubCliIpc.startAuth);
  yield* ipc.handle(GitHubCliIpc.disconnect);
  yield* ipc.handle(syncGitHubPluginConnectionMethod);
  ...
  yield* ipc.handle(pickFileOrFolder);
