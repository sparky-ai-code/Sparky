...
describe("native search worker environment", () => {
  it("removes legacy/static search credentials", () => {
    const input = {
      PATH: "test-path",
      SPARKY_SEARCH_WORKER_AUTH_TOKEN: "native-worker-auth-token",
