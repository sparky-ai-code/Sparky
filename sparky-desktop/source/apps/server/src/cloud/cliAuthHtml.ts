...
<html lang="en">
  <head>
    ...
    <title>Sparky Cloud authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Sparky Cloud. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
